...
Rscript ../src_MCMC/MCMC_source.R -p simknots -v 1 -K 3 -r 1 -s 4146 -i 50000 -b 25000 -c 1 -l 50 -m 5 -n 1 -o 10 -k 3
Rscript ../src_MCMC/MCMC_source.R -p simknots -v 1 -K 3 -r 2 -s 2941 -i 50000 -b 25000 -c 1 -l 50 -m 5 -n 1 -o 10 -k 4
Rscript ../src_MCMC/MCMC_source.R -p simknots -v 1 -K 3 -r 3 -s 2981 -i 50000 -b 25000 -c 1 -l 50 -m 5 -n 1 -o 10 -k 5
Rscript ../src_MCMC/MCMC_source.R -p simknots -v 1 -K 3 -r 4 -s 2882 -i 50000 -b 25000 -c 1 -l 50 -m 5 -n 1 -o 10 -k 6
Rscript ../src_MCMC/MCMC_source.R -p simknots -v 1 -K 3 -r 5 -s 7161 -i 50000 -b 25000 -c 1 -l 50 -m 5 -n 1 -o 10 -k 7
Rscript ../src_MCMC/MCMC_source.R -p simknots -v 1 -K 3 -r 6 -s 3364 -i 50000 -b 25000 -c 1 -l 50 -m 5 -n 1 -o 10 -k 8